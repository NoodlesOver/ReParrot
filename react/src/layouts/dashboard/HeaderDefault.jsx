...
const HeaderDefault = props => {
  ...
  const fetchMoreData = () => {
    setInfiniteScrollData(prevState => {
      let data = { ...prevState };
      data.dataLength += infiniteScrollData.dataLength;
      return data;
    });
  };
          ...
          <Nav className="navbar-nav navbar-right-wrap ms-auto d-flex align-items-center nav-top-wrap">
            <Dropdown as={Nav.Item}>
              ...
              >
                ...
                <InfiniteScroll
                  ...
                  dataLength={infiniteScrollData.dataLength}
                  next={fetchMoreData}
                  hasMore={true}
            ...
            <Dropdown as={Nav.Item}>
              ...
              >
                ...
                >
                  <i className="fe fe-book-open me-2"></i> Dashboard
                </Dropdown.Item>
                <Dropdown.Item>
                  <i className="fe fe-settings me-2"></i> Settings
                </Dropdown.Item>
                <Dropdown.Divider />
                <Dropdown.Item className="mb-3" onClick={props.logout}>
